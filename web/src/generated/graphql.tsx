...
export type LoginFormDataFragment = { __typename?: "UserResponse" } & {
...
export type CommentMutation = { __typename?: "Mutation" } & {
  comment: { __typename?: "Comment" } & Pick<Comment, "comment"> & {
...
export type DownvoteMutation = { __typename?: "Mutation" } & {
  downvote: { __typename?: "Post" } & Pick<
    Post,
    "id" | "title" | "upvoteCount"
  >;
};
...
export type LoginMutation = { __typename?: "Mutation" } & {
  login: { __typename?: "UserResponse" } & LoginFormDataFragment;
};
...
export type RegisterMutation = { __typename?: "Mutation" } & {
  register: { __typename?: "UserResponse" } & LoginFormDataFragment;
};
...
export type UpvoteMutation = { __typename?: "Mutation" } & {
  upvote: { __typename?: "Post" } & Pick<Post, "id" | "title" | "upvoteCount">;
};
...
export type PostQuery = { __typename?: "Query" } & {
  post?: Maybe<
    { __typename?: "Post" } & Pick<
      Post,
      "id" | "title" | "content" | "createdAt" | "upvoteCount" | "imgUrl"
...
export type UpvoteStatusQuery = { __typename?: "Query" } & Pick<
  Query,
  "upvoteStatus"
>;
...
export function useCommentMutation() {
  return Urql.useMutation<CommentMutation, CommentMutationVariables>(
    CommentDocument
  );
}
...
export function useDownvoteMutation() {
  return Urql.useMutation<DownvoteMutation, DownvoteMutationVariables>(
    DownvoteDocument
  );
}
...
export function useUpvoteMutation() {
  return Urql.useMutation<UpvoteMutation, UpvoteMutationVariables>(
    UpvoteDocument
  );
}
...
export function useUpvoteStatusQuery(
  options: Omit<Urql.UseQueryArgs<UpvoteStatusQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<UpvoteStatusQuery>({
    query: UpvoteStatusDocument,
    ...options,
  });
}
