...
export type RegularMerchantFragment = {
  __typename?: "Merchant";
  id: number;
  cpname: string;
...
export type RegularMerchantErrorFragment = {
  __typename?: "FieldMerchantError";
  field: string;
  merchantmsg: string;
};

export type RegularMerchantResponseFragment = {
  __typename?: "MerchantResponse";
  errors?: Maybe<
    Array<{
      __typename?: "FieldMerchantError";
...
export type AddLocationMutation = {
  __typename?: "Mutation";
  addLocation: { __typename?: "Merchant"; id: number };
};

export type AddMerchantTagMutationVariables = Exact<{
  tagId: Scalars["Int"] | undefined;
}>;

export type AddMerchantTagMutation = {
  __typename?: "Mutation";
  addMerchantTag: boolean;
};
...
export type AddReviewMutation = {
  ...
  addReview: {
    ...
    merchant: { __typename?: "Merchant"; cpname: string };
  };
};
...
export type ChangeFirstnameMutation = {
  __typename?: "Mutation";
  changeFirstname: { __typename?: "User"; firstname: string; lastname: string };
};
...
export type ChangeLastNameMutation = {
  __typename?: "Mutation";
  changeLastName: { __typename?: "User"; firstname: string; lastname: string };
};
...
export type TagsandMeQuery = {
  __typename?: "Query";
  tags: Array<{ __typename?: "Tag"; tagName: string; id: number }>;
  me: {
    __typename?: "MeResponse";
    merchant?: Maybe<{
      __typename?: "Merchant";
...
export type ReviewsQuery = {
  ...
  reviews: Array<{
    ...
    merchant: { __typename?: "Merchant"; cpname: string; id: number };
  }>;
};
...
export type TagsQuery = {
  __typename?: "Query";
  tags: Array<{ __typename?: "Tag"; tagName: string }>;
};
...
export function useAddLocationMutation() {
  return Urql.useMutation<AddLocationMutation, AddLocationMutationVariables>(
    AddLocationDocument
  );
}
...
export function useAddMerchantTagMutation() {
  return Urql.useMutation<
    AddMerchantTagMutation,
    AddMerchantTagMutationVariables
  >(AddMerchantTagDocument);
}
...
export function useAddReviewMutation() {
  return Urql.useMutation<AddReviewMutation, AddReviewMutationVariables>(
    AddReviewDocument
  );
}
...
export function useChangeFirstnameMutation() {
  return Urql.useMutation<
    ...
    ChangeFirstnameMutationVariables
  >(ChangeFirstnameDocument);
}
...
export function useChangeLastNameMutation() {
  return Urql.useMutation<
    ...
    ChangeLastNameMutationVariables
  >(ChangeLastNameDocument);
}
...
export const LoginmDocument = gql`
  mutation Loginm($usernameOrEmail: String!, $password: String!) {
    loginm(
      options: { usernameOrEmail: $usernameOrEmail, password: $password }
    ) {
...
export function useLoginmMutation() {
  return Urql.useMutation<LoginmMutation, LoginmMutationVariables>(
    LoginmDocument
  );
}
...
export function useLogoutmMutation() {
  return Urql.useMutation<LogoutmMutation, LogoutmMutationVariables>(
    LogoutmDocument
  );
}
...
export function useRegistermMutation() {
  return Urql.useMutation<RegistermMutation, RegistermMutationVariables>(
    RegistermDocument
  );
}
...
export function useTagsandMeQuery(
  options: Omit<Urql.UseQueryArgs<TagsandMeQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<TagsandMeQuery>({
...
export function useMerchantsQuery(
  options: Omit<Urql.UseQueryArgs<MerchantsQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<MerchantsQuery>({
